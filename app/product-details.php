...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3><?php echo $datas["gtitle"]?></h3>
          <span class="breadcrumb"><a href="index.php">Home</a>  >  <a href="#">Shop</a>  >  <?php echo $datas["gtitle"]?></span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center">
          <h4><?php echo $datas["gtitle"]?></h4>
          <span class="price"><?php echo $datas["price"]?>₺</span>
          <p></p>
          <form id="qty" action="#">
          ...
          <ul>
            <li><span>Category:</span> <?php echo $datas["categoryName"]?></li>
          </ul>
        </div>
        <div class="col-lg-12">
          <div class="sep"></div>
