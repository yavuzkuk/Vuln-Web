      ...
      <div class="row">
        ...
        <?php foreach($lastGames as $game):?>
          <div class="col-lg-3 col-md-6">
            <div class="item">
              <div class="thumb">
                <a href="product-details.php?id=<?php echo $game["id"]?>"><img src="assets/images/trending-01.jpg" alt=""></a>
                <span class="price"><?php echo $game["price"]?>₺</span>
              </div>
              <div class="down-content">
                <span class="category"><?php echo $game["categoryName"]?></span>
                <h4><?php echo $game["gtitle"]?></h4>
                <a href="product-details.php?id=<?php echo $game["id"]?>"><i class="fa fa-shopping-bag"></i></a>
              </div>
            </div>
          </div>
        <?php endforeach?>
